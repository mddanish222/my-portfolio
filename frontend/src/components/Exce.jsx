  ...
  return (
    <div style={container}>
      ...
      {Array.isArray(experience) && experience.map((exp) => (
        <div key={exp.id || exp._id} style={expCard}>
          <div style={expHeader}>
            <div>
        ...
        <div style={certGrid}>
          {Array(4).fill(null).map((_, i) => (
            ...
            >
              ...
              />
              <div style={{ flex: 1 }}>
                <div className="skeleton-box" style={{ width: "75%", height: "15px", marginBottom: "8px" }} />
                <div className="skeleton-box" style={{ width: "55%", height: "12px", marginBottom: "8px" }} />
                <div className="skeleton-box" style={{ width: "35%", height: "10px" }} />
              </div>
            </div>
          ))}
        </div>
    ...
    <div style={container}>
      ...
      <div style={certGrid}>
        {Array.isArray(certs) && certs.map((cert) => (
          <div key={cert.id || cert._id} style={certCard}>
